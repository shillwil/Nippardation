...
import Foundation
let upperStrength = Workout(
    name: "Upper (Strength Focus)",
    exercises: [
        Exercise(
            type:ExerciseType(name: "45° Incline Barbell Press", muscleGroup: [.chest, .shoulders]),
            example: """
        ...
        Exercise(
            type: ExerciseType(name: "Cable Crossover Ladder", muscleGroup: [.chest]),
            example: """
        ...
        Exercise(
            type: ExerciseType(name: "Wide Grip Pull-Up", muscleGroup: [.back]),
            example: """
        ...
        Exercise(
            type: ExerciseType(name: "Pendlay Deficit Row", muscleGroup: [.back, .biceps]),
            example: """
        ...
        Exercise(
            type: ExerciseType(name: "Bayesian Cable Curl", muscleGroup: [.biceps]),
            example: """
